...
def main():
    ...
    model = torch.load("model_weight/netA_n_classes_10_label5_unlabel95_rand30.pth")
    ...
    scatter(eval_tsne_embeds, target.astype('int64'), "TripleGAN_n_classes_16_label5_unlabel95", 16)
    visualize_data(X_test_embedding_feature_map, target.astype('int64'), "Visualization/TripleGAN_n_classes_16_5label_95unlabel_improved", 16)
