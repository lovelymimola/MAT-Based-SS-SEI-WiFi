...
def main():
    ...
    model = torch.load("model_weight/SSRCNN_n_classes_16_5label_95unlabel_rand30.pth")
    ...
    scatter(eval_tsne_embeds, target.astype('int64'), "SSRCNN_n_classes_16_5label_95unlabel", 16)
    visualize_data(X_test_embedding_feature_map, target.astype('int64'), "Visualization/SSRCNN_n_classes_16_5label_95unlabel_improved", 16)
