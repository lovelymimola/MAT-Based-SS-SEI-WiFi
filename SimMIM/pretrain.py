...
def train_and_test(encoder,
    ...
    for epoch in range(1, epochs + 1):
        ...
        print("------------------------------------------------")
    time = (time.time()-start_time)/epochs
    print(time)
class Config:
    def __init__(
        self,
...
def main():
    ...
    train_dataset_unlabel = TensorDataset(torch.Tensor(X_train_unlabel), torch.Tensor(Y_train_unlabel))
