...
def main():
    ...
    model = torch.load("model_weight/SimMIM_encoder_mask05_n_classes_16_label5.pth")
    ...
    scatter(eval_tsne_embeds, target.astype('int64'), "SimMIM_encoder_mask05_n_classes_16_label5", 16)
    visualize_data(X_test_embedding_feature_map, target.astype('int64'), "Visualization/SimMIM_encoder_mask05_n_classes_16_label5_improved", 16)
