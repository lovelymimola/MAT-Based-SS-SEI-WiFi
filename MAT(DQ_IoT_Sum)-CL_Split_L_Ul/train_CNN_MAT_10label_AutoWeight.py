...
class Config:
    def __init__(
        ...
        n_classes: int = 16,
        ft: int = 62,
        save_path: str = 'model_weight/CNN_MAT1_n_classes_16_10label_90unlabel_rand30_NormFeature_lr0001_autoweight0.pth',
        device_num: int = 0,
        rand_num: int = 30,
        ):
...
def main():
    conf = Config()
    writer = SummaryWriter("logs_CNN_MAT1_n_classes_16_10label_90unlabel_rand30_NormFeature_lr0001_autoweight0")
