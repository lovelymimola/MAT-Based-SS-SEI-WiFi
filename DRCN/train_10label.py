...
def train_and_test(encoder,
    ...
    for epoch in range(1, epochs + 1):
        ...
        train_label_dataloader = DataLoader(train_label_dataset, batch_size=label_batch_size, shuffle=True)
...
def main():
    ...
    X_train_label, X_train, X_val, Y_train_label, Y_train, Y_val = TrainDataset(conf.ft, conf.rand_num)
    ...
    train_and_test(encoder=encoder,
                   ...
                   label_batch_size=conf.train_label_batch_size,
                   train_dataset= train_dataset,
                   batch_size=conf.train_batch_size,
                   val_dataset=val_dataset,
                   val_batch_size=conf.test_batch_size,
