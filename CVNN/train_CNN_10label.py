...
class Config:
    def __init__(
        ...
        lr: float = 0.001,
        ft: int = 62,
        save_path: str = 'model_weight/CNN_n_classes_10_10label_90unlabel_rand30.pth',
        device_num: int = 0,
        rand_num: int = 30,
        ):
...
def main():
    ...
    X_train_labeled, X_train, X_val, value_Y_train_labeled, value_Y_train, value_Y_val = TrainDataset(conf.ft, conf.rand_num)
